...
parser.add_argument("--model_name_or_path", default='/home/ubuntu/Model/bert-base-uncased')
...
if args.dataset == "agnews":
    ...
    max_seq_l = 128
    batch_s = 30
elif args.dataset == "human-chatgpt1":
    dataset['train'] = Human_gptProcessor().get_train_examples("./datasets/TextClassification/human-chatgpt1/")
    dataset['test'] = Human_gptProcessor().get_test_examples("./datasets/TextClassification/human-chatgpt1/")
    class_labels =Human_gptProcessor().get_labels()
    scriptsbase = "TextClassification/human-chatgpt1"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = args.batch_size
elif args.dataset == "A-M":
    dataset['train'] = Human_gptProcessor().get_train_examples("./datasets/TextClassification/A-M/")
    dataset['test'] = Human_gptProcessor().get_test_examples("./datasets/TextClassification/A-M/")
    class_labels =Human_gptProcessor().get_labels()
    scriptsbase = "TextClassification/A-M"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = args.batch_size
elif args.dataset == "A-S":
    dataset['train'] = Human_gptProcessor().get_train_examples("./datasets/TextClassification/A-S/")
    dataset['test'] = Human_gptProcessor().get_test_examples("./datasets/TextClassification/A-S/")
    class_labels =Human_gptProcessor().get_labels()
    scriptsbase = "TextClassification/A-S"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = args.batch_size
elif args.dataset == "M-A":
    dataset['train'] = Human_gptProcessor().get_train_examples("./datasets/TextClassification/M-A/")
    dataset['test'] = Human_gptProcessor().get_test_examples("./datasets/TextClassification/M-A/")
    class_labels =Human_gptProcessor().get_labels()
    scriptsbase = "TextClassification/M-A"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = args.batch_size
elif args.dataset == "M-S":
    dataset['train'] = Human_gptProcessor().get_train_examples("./datasets/TextClassification/M-S/")
    dataset['test'] = Human_gptProcessor().get_test_examples("./datasets/TextClassification/M-S/")
    class_labels =Human_gptProcessor().get_labels()
    scriptsbase = "TextClassification/M-S"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = args.batch_size
elif args.dataset == "S-M":
    dataset['train'] = Human_gptProcessor().get_train_examples("./datasets/TextClassification/S-M/")
    dataset['test'] = Human_gptProcessor().get_test_examples("./datasets/TextClassification/S-M/")
    class_labels =Human_gptProcessor().get_labels()
    scriptsbase = "TextClassification/S-M"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = args.batch_size
elif args.dataset == "S-A":
    dataset['train'] = Human_gptProcessor().get_train_examples("./datasets/TextClassification/S-A/")
    dataset['test'] = Human_gptProcessor().get_test_examples("./datasets/TextClassification/S-A/")
    class_labels =Human_gptProcessor().get_labels()
    scriptsbase = "TextClassification/S-A"
    scriptformat = "txt"
    cutoff=0.5
    max_seq_l = 128
    batch_s = args.batch_size
...
def evaluate2(prompt_model, dataloader, desc):
    ...
    for step, inputs in enumerate(pbar):
        ...
        f_w = open(f'./{args.dataset}_prelabel_0.csv', 'w', encoding='utf-8')
